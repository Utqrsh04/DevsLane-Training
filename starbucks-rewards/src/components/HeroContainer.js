...
function HeroContainer() {
    return (
        <div>
            <section className="mt-38 lg:mt-36 bg-hero-desktop bg-no-repeat bg-1/2 bg-auto-100% md:bg-2/2.5 md:bg-auto-50% bg-primary-lightShade py-72 px-8 2xl:py-1/5 md:pb-full md:pt-8 md:mt-28 md:text-center ">
                ...
                <div className="max-w-8xl mx-auto flex-col text-left md:flex ">
                    ...
                    <button
                        className="ml-2 py-1 px-4 border rounded-3xl bg-primary-darkerShade text-white 
                        font-semibold hover:bg-primary-darkShade md:mx-auto  ">
                    ...
                    <p className="mt-4 text-lg max-w-sm md:mx-auto md:text-base"><span className="md:hidden">Or <a
                            ...
                            experience</span><a className="hidden md:inline underline" href="#">Or join online</a>
                    </p>
                </div>
            </section>
        </div>
