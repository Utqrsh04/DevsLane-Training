...
function CashOrCard() {
  return (
    <div>
      ...
      <section className="bg-secondry-yellowShade py-12">
        <h1 className="text-3xl font-semibold max-w-sm md:text-2xl text-center mx-auto mb-4 ">
          Cash or card, you earn Stars
        </h1>
        <p className="max-w-2xl text-center mx-auto md:text-sm mb-20 px-8">
        ...
        <div className="max-w-8xl mx-auto flex justify-start px-8 lg:flex-wrap">
          <div className="w-1/6 min-w-1/6 lg:w-full lg:mb-8 text-left">
            <h1 className="text-2xl md:text-xl font-semibold mb-2 w-full">
              Up to 3 &nbsp;
            ...
            <p className="text-base md:text-sm leading-snug w-full">
          ...
          <div className="max-w-7.5 flex mx-7 lg:mx-0 2xl:flex-1 md:max-w-full">
            ...
            <div className="text-left">
              <h1 className="text-xl md:text-lg font-semibold mb-4">
                Earn Stars even faster
              </h1>
              <p className="leading-normal md:text-sm font-medium">
