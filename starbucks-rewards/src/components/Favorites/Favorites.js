...
function Favorites() {
  return (
    <div>
      <section className="py-16 bg-primary-lightestShade">
        <h1 className="text-3xl font-semibold text-center mb-12 px-8">
          Get your favorites for free
        </h1>
        <div className="max-w-lg md:max-w-full flex text-3xl justify-between mx-auto">
          <h1 className="relative py-4 px-2 font-semibold md:w-full text-center md:px-0">
            25<span className="text-yellow-500 text-lg">★</span>
            <span className="absolute w-full h-1 bg-primary-darkerShade bottom-0 right-0 left-0"></span>
          </h1>
